...
public class UserProfile extends TableImpl<UserProfileRecord> {
     ...
     */
    public final TableField<UserProfileRecord, Integer> ID = createField(DSL.name("ID"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>USER_PROFILE.USER_PROFILE_ID</code>.
     */
    public final TableField<UserProfileRecord, String> USER_PROFILE_ID = createField(DSL.name("USER_PROFILE_ID"), SQLDataType.VARCHAR(36).nullable(false), this, "");
    ...
    public List<UniqueKey<UserProfileRecord>> getKeys() {
        return Arrays.<UniqueKey<UserProfileRecord>>asList(Keys.CONSTRAINT_C);
    }
