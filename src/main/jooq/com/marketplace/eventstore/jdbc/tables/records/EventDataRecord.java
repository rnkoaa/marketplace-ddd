...
public class EventDataRecord extends UpdatableRecordImpl<EventDataRecord> implements Record8<String, String, String, String, String, Integer, String, String> {
     ...
     */
    public EventDataRecord(String id, String eventId, String aggregateName, String aggregateId, String eventType, Integer eventVersion, String data, String created) {
        super(EventData.EVENT_DATA);
